    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4">
            <div className="max-w-md w-full text-center">
                ...
                <div className="bg-muted border border-border rounded-3xl p-6 mb-6">
                    <h2 className="text-sm font-black uppercase tracking-widest text-foreground/40 mb-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    <button
                        ...
                        className="flex-1 bg-primary text-primary-foreground font-black uppercase tracking-widest text-xs py-4 px-6 rounded-xl hover:scale-105 transition-transform active:scale-95 shadow-lg shadow-primary/30 flex items-center justify-center gap-2"
                    >
                        <RefreshCw size={16} />
                        Try Again
                    </button>
                    ...
                    <Link
                        href="/"
                        className="flex-1 bg-muted border border-border text-foreground font-black uppercase tracking-widest text-xs py-4 px-6 rounded-xl hover:bg-muted/70 transition-colors flex items-center justify-center gap-2"
                    >
                        <Home size={16} />
                        Go Home
                    </Link>
