...
export async function PATCH(
    ...
    try {
        ...
        console.error('Error updating squad player:', error);
        return NextResponse.json({ error: 'Failed to update squad player' }, { status: 500 });
    } finally {
...
export async function DELETE(
    ...
    try {
        ...
        console.error('Error deleting squad player:', error);
        return NextResponse.json({ error: 'Failed to delete squad player' }, { status: 500 });
    } finally {
        // no resources to release
    }
}
