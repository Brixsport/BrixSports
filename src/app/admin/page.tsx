                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-white/5 text-[8px] md:text-[10px] font-black uppercase tracking-widest text-white/30 text-nowrap">
                      <th className="p-2 sm:p-4 md:p-6 whitespace-nowrap">Match</th>
                      <th className="p-2 sm:p-4 md:p-6">Status</th>
                      <th className="p-2 sm:p-4 md:p-6">Assigned Logger</th>
                      <th className="hidden sm:table-cell p-2 sm:p-4 md:p-6">Health</th>
                      <th className="p-2 sm:p-4 md:p-6 text-right">Actions</th>
                    </tr>
                  </thead>
                        ...
                        <tr key={match.id} className="group hover:bg-white/5 transition-colors">
                          <td className="p-2 sm:p-4 md:p-6">
                            <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3">
                              ...
                              <div className="min-w-0">
                                <p className="text-[11px] md:text-sm font-bold truncate max-w-[80px] sm:max-w-[120px] md:max-w-none">{homeTeam?.shortName || 'TBD'} vs {awayTeam?.shortName || 'TBD'}</p>
                          ...
                          <td className="p-2 sm:p-4 md:p-6">
                            <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3">
                              ...
                              <p className="text-[10px] md:text-xs font-bold italic truncate max-w-[50px] sm:max-w-[80px] md:max-w-none">{logger?.name || 'Unassigned'}</p>
                            </div>
                          </td>
                          <td className="hidden sm:table-cell p-2 sm:p-4 md:p-6">
                          ...
                          <td className="p-2 sm:p-4 md:p-6 text-right">
                            <button className="p-1 sm:p-1.5 md:p-2 hover:bg-white/10 rounded-lg transition-colors">
