    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-purple-100/50 to-purple-50 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 flex items-center justify-center px-4">
            <motion.div
                ...
                className="max-w-2xl w-full bg-card/80 border border-border backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-2xl text-center"
            >
                <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                ...
                <motion.div
                    ...
                    className="bg-muted border border-border rounded-xl p-6 mb-8"
                >
                ...
                >
                    ...
                    <Link
                        href="/"
                        className="px-6 py-3 bg-muted hover:bg-muted/70 text-foreground font-semibold rounded-lg transition-all flex items-center justify-center gap-2"
                    >
