                    ...
                    <div className="max-w-3xl mx-auto px-4">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <div className="flex flex-col items-center">
                                <span className="text-[10px] font-bold tracking-[0.2em] text-foreground/40 uppercase mb-1">
                                    {match.competition}
                                </span>
                        ...
                        <div className="flex items-center justify-between gap-4 md:gap-12 mb-8">
                            ...
                            >
                                <div className="w-20 h-20 md:w-24 md:h-24 relative rounded-2xl overflow-hidden bg-muted border border-border mb-4 group-hover:border-primary/50 transition-colors shadow-lg shadow-black/50">
                                ...
                                <h2 className="font-bold text-lg md:text-xl text-foreground group-hover:text-primary transition-colors">
                                    {match.homeTeam?.name || 'Home'}
                                </h2>
                                {match.homeTeam?.college && (
                                    <span className="text-xs text-foreground/40 mt-1">{match.homeTeam.college}</span>
                                )}
                            </div>

                            {/* Score */}
                            <div className="flex flex-col items-center">
                                <div className="flex items-center gap-4 bg-muted px-6 py-3 rounded-2xl border border-border backdrop-blur-sm mb-2">
                                    <span className={`text-4xl md:text-6xl font-black tabular-nums tracking-tighter ${match.homeScore > match.awayScore ? 'text-foreground' : 'text-foreground/60'}`}>
                                        {match.homeScore}
                                    </span>
                                    <span className="text-foreground/10 text-2xl md:text-4xl font-light mx-2">:</span>
                                    <span className={`text-4xl md:text-6xl font-black tabular-nums tracking-tighter ${match.awayScore > match.homeScore ? 'text-foreground' : 'text-foreground/60'}`}>
                                        {match.awayScore}
                                    </span>
                                </div>
                            ...
                            >
                                ...
                                {match.awayTeam?.college && (
                                    <span className="text-xs text-foreground/40 mt-1">{match.awayTeam.college}</span>
                                )}
                            </div>
                        </div>

                        {/* Metadata */}
                        <div className="flex items-center justify-center gap-6 text-xs text-foreground/40 pb-2 border-b border-border">
                ...
                <div className="flex-1 max-w-3xl mx-auto w-full px-4 py-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-muted rounded-2xl border border-border overflow-hidden">
                                ...
                                <div className="p-6 space-y-4">
                                    ...
                                    <div className="flex justify-between items-center py-2 border-b border-border">
                                        <span className="text-foreground/40">Competition</span>
                                        <span className="font-medium text-foreground">{match.competition}</span>
                                    </div>
                                    <div className="flex justify-between items-center py-2 border-b border-border">
                                        <span className="text-foreground/40">Round</span>
                                    ...
                                    {(match.sport as string) === 'Table Tennis' && (
                                        <div className="flex justify-between items-center py-2">
                                            ...
                                            <span className="font-medium text-foreground">Best of 5 Sets</span>
                                        </div>
                                    )}
                                    {(match.sport as string) === 'Chess' && (
                                        <div className="flex justify-between items-center py-2">
                                            <span className="text-foreground/40">Time Control</span>
                            ...
                            {(['Table Tennis', 'Volleyball', 'Tennis'].includes(match.sport as string)) && (match.stats as any)?.sets && (
                                <div className="bg-muted rounded-2xl border border-border overflow-hidden">
                                    <div className="p-4 border-b border-border bg-muted flex justify-between items-center">
                                        <h3 className="font-bold text-foreground/80">Set Scores</h3>
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 text-xs font-bold text-foreground/40 uppercase">Home</div>
                                            ...
                                            {/* Away Team Row */}
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 text-xs font-bold text-foreground/40 uppercase">Away</div>
                                                <div className="flex-1 flex gap-2">
                                                    {Array.isArray((match.stats as any).sets) && (match.stats as any).sets.map((set: [number, number], i: number) => (
                                        ...
                                        <div className="flex items-center gap-4 mt-2">
                                            ...
                                            <div className="flex-1 flex gap-2">
                                                {Array.isArray((match.stats as any).sets) && (match.stats as any).sets.map((_: any, i: number) => (
                                                    <div key={`label-${i}`} className="w-8 text-center text-[10px] text-foreground/20 uppercase">
                                                        S{i + 1}
                                                    </div>
                                                ))}
                                            </div>
                    ...
                    {activeTab === 'lineups' && (
                        <div className="bg-muted rounded-2xl border border-border p-8 text-center">
                            ...
                            <p className="text-foreground/60">Player lists not available for this match type yet.</p>
                        </div>
                    )}
                </div>
            </div>
