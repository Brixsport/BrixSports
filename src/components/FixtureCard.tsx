...
import { Clock, MapPin, Bell, BellOff, Calendar, Video } from 'lucide-react';
                ...
                <div className="p-4">
                    ...
                    {isUpcoming && (
                        <div className="flex flex-col gap-3 mt-4">
                            ...
                            {fixture.livestreamEnabled && (
                                <div className="flex items-center justify-center gap-2 p-2 rounded-lg bg-red-500/10 border border-red-500/20 text-red-400 text-sm font-medium">
