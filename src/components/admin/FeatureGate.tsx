...
export function FeatureGate({ flagKey, featureName, children }: FeatureGateProps) {
        ...
        return (
            <div className="min-h-[60vh] flex items-center justify-center p-8">
                <div className="max-w-md text-center space-y-4">
                    ...
                    <h1 className="text-xl font-bold text-white">{featureName} is temporarily disabled</h1>
                    <p className="text-sm text-white/50">
                        This panel has been gated off ahead of a live match. Re-enable it from Admin &rarr; Settings &rarr; Feature Flags.
                    </p>
                </div>
            </div>
        );
