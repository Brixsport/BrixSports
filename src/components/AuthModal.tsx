                ...
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
                        <motion.div
                            ...
                            className="w-full max-w-md bg-card border border-border rounded-3xl shadow-2xl overflow-hidden pointer-events-auto relative"
                        >
                            ...
                            <div className="relative p-8">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    required
                                                    className="w-full bg-muted border border-border rounded-xl pl-12 pr-4 py-3 text-foreground placeholder:text-foreground/30 focus:outline-none focus:border-primary/50 focus:bg-muted transition-all"
                                                />
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                required
                                                className="w-full bg-muted border border-border rounded-xl pl-12 pr-12 py-3 text-foreground placeholder:text-foreground/30 focus:outline-none focus:border-primary/50 focus:bg-muted transition-all"
                                            />
                                            <button
                                                type="button"
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-primary hover:bg-primary/90 disabled:bg-primary/60 text-primary-foreground font-black uppercase tracking-widest text-sm py-4 rounded-xl transition-all disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-primary/20"
                                    >
                                        {isLoading ? (
                                            <>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <button
                                        type="button"
                                        className="flex items-center justify-center gap-2 bg-muted hover:bg-muted/70 border border-border rounded-xl py-3 transition-all"
                                    >
