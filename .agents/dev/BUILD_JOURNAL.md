...
**Next session — exact first task:** live-verify BUG-239, BUG-241, BUG-242, BUG-243 against a real match (all four are `SHIPPED`, zero live confirmation) — this is the in-progress task as this entry is being written.
