...
- Not yet visually click-verified against a running server — local dev server became unstable mid-session; verification moving to the deployed `dev`/staging environment instead (see below).
