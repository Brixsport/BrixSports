...
**Status:** SHIPPED — 2026-08-22 (session 53 continuation). Fix applied, **NOT yet live-tested** — a fresh beta-tester agent re-run of Flow A (Create Match, iPad Air — see viewport note below) is queued to provide the live evidence needed to move this to RESOLVED.
