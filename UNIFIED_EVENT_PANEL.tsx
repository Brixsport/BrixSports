// MOBILE-OPTIMIZED UNIFIED EVENT PANEL
...
<div className="space-y-3 sm:space-y-4">
    ...
    {/* UNIFIED EVENT PANEL - All events in one place */}
    <div className="bg-white/5 border border-white/10 rounded-xl sm:rounded-[24px] p-3 sm:p-6">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2 sm:gap-3">
            ...
            >
                <span className="text-2xl sm:text-3xl mb-1">🧤</span>
                <span className="text-[9px] sm:text-[10px] font-bold text-white/80 text-center leading-tight">Claim</span>
            </button>
